...
public class Student_Medical {
    ...
    public Student_Medical() {
        ...
        try {
            ...
            e.printStackTrace(); // Good to catch database errors
        }

        // ✅ Add button listeners INSIDE the constructor
        ...
        frame.setVisible(true); // ✅ Don't forget this! Show the frame after setting up everything
    }
